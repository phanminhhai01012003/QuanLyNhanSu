    ...
    public class QuanLyLuongController : Controller
    {
        ...
        public ActionResult ThanhToanLuong()
        {
            ...
            foreach (var item in luong)
            {
                ...
                KhenThuong kt = new KhenThuong(); // Test
                ...
                var kth = db.KhenThuongs.Where(n => n.MaNhanVien == kt.MaNhanVien).FirstOrDefault();
                ...
                kt.TienThuong = kt.TienThuong == null ? 0 : kt.TienThuong;
                tienthuong = (int)kt.TienThuong;
                ct.TienThuong = (int)tienthuong;
        ...
        public ActionResult CapNhatPhuCap(ChucVuNhanVien cv, String id, FormCollection f)
        {
            ...
            return RedirectToAction("CapNhatPhuCap", "QuanLyLuong");
        }
